...
namespace UnitTestProject
{
    public class UserCreation1
    {
        ...
        public async Task CreateNewUserSuccessfully()
        {
            ...
            // שלב 1: ודא שהבקשה הצליחה
            Assert.True(createPatientResponse.IsSuccessful);
            Assert.False(!createPatientResponse.IsSuccessful);
        }
    }
}