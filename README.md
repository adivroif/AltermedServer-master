...
| Member | Role | Profile |
|--------|------|---------|
| <img src="./docs/team/veronika.png" width="80" style="border-radius:50%;"> | **Veronika Merkulova** – Backend & System Architecture | [LinkedIn](https://www.linkedin.com/in/veronikamerkulova-software/) • [GitHub](https://github.com/VeroniMe) |
